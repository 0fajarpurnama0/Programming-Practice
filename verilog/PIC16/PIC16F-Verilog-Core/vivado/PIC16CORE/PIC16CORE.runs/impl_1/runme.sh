...
HD_PWD='/lab/hicc/fajar/Documents/Programming-Practice/verilog/PIC16/PIC16F-Verilog-Core/vivado/PIC16CORE/PIC16CORE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pic16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pic16.tcl -notrace
