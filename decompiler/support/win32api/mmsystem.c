...
LRESULT WINAPI CloseDriver(HDRVR a,LONG b,LONG c){}
HDRVR WINAPI OpenDriver(LPCWSTR a,LPCWSTR b,LONG c){}
LRESULT WINAPI SendDriverMessage(HDRVR a,UINT b,LONG c,LONG d){}
HMODULE WINAPI DrvGetModuleHandle(HDRVR a){}
HMODULE WINAPI GetDriverModuleHandle(HDRVR a){}
LRESULT WINAPI DefDriverProc(DWORD a,HDRVR b,UINT c,LPARAM d,LPARAM e){}
UINT WINAPI mmsystemGetVersion(void){}
#define OutputDebugStr OutputDebugString
BOOL WINAPI sndPlaySoundA(LPCSTR a,UINT b){}
BOOL WINAPI sndPlaySoundW(LPCWSTR a,UINT b){}
BOOL WINAPI PlaySoundA(LPCSTR a,HMODULE b,DWORD c){}
BOOL WINAPI PlaySoundW(LPCWSTR a,HMODULE b,DWORD c){}
UINT WINAPI waveOutGetNumDevs(void){}
MMRESULT WINAPI waveOutGetDevCapsA(UINT a,LPWAVEOUTCAPSA b,UINT c){}
MMRESULT WINAPI waveOutGetDevCapsW(UINT a,LPWAVEOUTCAPSW b,UINT c){}
MMRESULT WINAPI waveOutGetVolume(HWAVEOUT a,PDWORD b){}
MMRESULT WINAPI waveOutSetVolume(HWAVEOUT a,DWORD b){}
MMRESULT WINAPI waveOutGetErrorTextA(MMRESULT a,LPSTR b,UINT c){}
MMRESULT WINAPI waveOutGetErrorTextW(MMRESULT a,LPWSTR b,UINT c){}
MMRESULT WINAPI waveOutOpen(LPHWAVEOUT a,UINT b,LPCWAVEFORMATEX c,DWORD d,DWORD e,DWORD f){}
MMRESULT WINAPI waveOutClose(HWAVEOUT a){}
MMRESULT WINAPI waveOutPrepareHeader(HWAVEOUT a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveOutUnprepareHeader(HWAVEOUT a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveOutWrite(HWAVEOUT a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveOutPause(HWAVEOUT a){}
MMRESULT WINAPI waveOutRestart(HWAVEOUT a){}
MMRESULT WINAPI waveOutReset(HWAVEOUT a){}
MMRESULT WINAPI waveOutBreakLoop(HWAVEOUT a){}
MMRESULT WINAPI waveOutGetPosition(HWAVEOUT a,LPMMTIME b,UINT c){}
MMRESULT WINAPI waveOutGetPitch(HWAVEOUT a,PDWORD b){}
MMRESULT WINAPI waveOutSetPitch(HWAVEOUT a,DWORD b){}
MMRESULT WINAPI waveOutGetPlaybackRate(HWAVEOUT a,PDWORD b){}
MMRESULT WINAPI waveOutSetPlaybackRate(HWAVEOUT a,DWORD b){}
MMRESULT WINAPI waveOutGetID(HWAVEOUT a,LPUINT b){}
MMRESULT WINAPI waveOutMessage(HWAVEOUT a,UINT b,DWORD c,DWORD d){}
UINT WINAPI waveInGetNumDevs(void){}
MMRESULT WINAPI waveInGetDevCapsA(UINT a,LPWAVEINCAPSA b,UINT c){}
MMRESULT WINAPI waveInGetDevCapsW(UINT a,LPWAVEINCAPSW b,UINT c){}
MMRESULT WINAPI waveInGetErrorTextA(MMRESULT a,LPSTR b,UINT c){}
MMRESULT WINAPI waveInGetErrorTextW(MMRESULT a,LPWSTR b,UINT c){}
MMRESULT WINAPI waveInOpen(LPHWAVEIN a,UINT b,LPCWAVEFORMATEX c,DWORD d,DWORD e,DWORD f){}
MMRESULT WINAPI waveInClose(HWAVEIN a){}
MMRESULT WINAPI waveInPrepareHeader(HWAVEIN a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveInUnprepareHeader(HWAVEIN a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveInAddBuffer(HWAVEIN a,LPWAVEHDR b,UINT c){}
MMRESULT WINAPI waveInStart(HWAVEIN a){}
MMRESULT WINAPI waveInStop(HWAVEIN a){}
MMRESULT WINAPI waveInReset(HWAVEIN a){}
MMRESULT WINAPI waveInGetPosition(HWAVEIN a,LPMMTIME b,UINT c){}
MMRESULT WINAPI waveInGetID(HWAVEIN a,LPUINT b){}
MMRESULT WINAPI waveInMessage(HWAVEIN a,UINT b,DWORD c,DWORD d){}
UINT WINAPI midiOutGetNumDevs(void){}
MMRESULT WINAPI midiStreamOpen(LPHMIDISTRM a,LPUINT b,DWORD c,DWORD d,DWORD e,DWORD f){}
MMRESULT WINAPI midiStreamClose(HMIDISTRM a){}
MMRESULT WINAPI midiStreamProperty(HMIDISTRM a,LPBYTE b,DWORD c){}
MMRESULT WINAPI midiStreamPosition(HMIDISTRM a,LPMMTIME b,UINT c){}
MMRESULT WINAPI midiStreamOut(HMIDISTRM a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiStreamPause(HMIDISTRM a){}
MMRESULT WINAPI midiStreamRestart(HMIDISTRM a){}
MMRESULT WINAPI midiStreamStop(HMIDISTRM a){}
MMRESULT WINAPI midiConnect(HMIDI a,HMIDIOUT b,PVOID c){}
MMRESULT WINAPI midiDisconnect(HMIDI a,HMIDIOUT b,PVOID c){}
MMRESULT WINAPI midiOutGetDevCapsA(UINT a,LPMIDIOUTCAPSA b,UINT c){}
MMRESULT WINAPI midiOutGetDevCapsW(UINT a,LPMIDIOUTCAPSW b,UINT c){}
MMRESULT WINAPI midiOutGetVolume(HMIDIOUT a,PDWORD b){}
MMRESULT WINAPI midiOutSetVolume(HMIDIOUT a,DWORD b){}
MMRESULT WINAPI midiOutGetErrorTextA(MMRESULT a,LPSTR b,UINT c){}
MMRESULT WINAPI midiOutGetErrorTextW(MMRESULT a,LPWSTR b,UINT c){}
MMRESULT WINAPI midiOutOpen(LPHMIDIOUT a,UINT b,DWORD c,DWORD d,DWORD e){}
MMRESULT WINAPI midiOutClose(HMIDIOUT a){}
MMRESULT WINAPI midiOutPrepareHeader(HMIDIOUT a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiOutUnprepareHeader(HMIDIOUT a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiOutShortMsg(HMIDIOUT a,DWORD b){}
MMRESULT WINAPI midiOutLongMsg(HMIDIOUT a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiOutReset(HMIDIOUT a){}
MMRESULT WINAPI midiOutCachePatches(HMIDIOUT a,UINT b,LPWORD c,UINT d){}
MMRESULT WINAPI midiOutCacheDrumPatches(HMIDIOUT a,UINT b,LPWORD c,UINT d){}
MMRESULT WINAPI midiOutGetID(HMIDIOUT a,LPUINT b){}
MMRESULT WINAPI midiOutMessage(HMIDIOUT a,UINT b,DWORD c,DWORD d){}
UINT WINAPI midiInGetNumDevs(void){}
MMRESULT WINAPI midiInGetDevCapsA(UINT a,LPMIDIINCAPSA b,UINT c){}
MMRESULT WINAPI midiInGetDevCapsW(UINT a,LPMIDIINCAPSW b,UINT c){}
MMRESULT WINAPI midiInGetErrorTextA(MMRESULT a,LPSTR b,UINT c){}
MMRESULT WINAPI midiInGetErrorTextW(MMRESULT a,LPWSTR b,UINT c){}
MMRESULT WINAPI midiInOpen(LPHMIDIIN a,UINT b,DWORD c,DWORD d,DWORD e){}
MMRESULT WINAPI midiInClose(HMIDIIN a){}
MMRESULT WINAPI midiInPrepareHeader(HMIDIIN a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiInUnprepareHeader(HMIDIIN a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiInAddBuffer(HMIDIIN a,LPMIDIHDR b,UINT c){}
MMRESULT WINAPI midiInStart(HMIDIIN a){}
MMRESULT WINAPI midiInStop(HMIDIIN a){}
MMRESULT WINAPI midiInReset(HMIDIIN a){}
MMRESULT WINAPI midiInGetID(HMIDIIN a,LPUINT b){}
MMRESULT WINAPI midiInMessage(HMIDIIN a,UINT b,DWORD c,DWORD d){}
UINT WINAPI auxGetNumDevs(void){}
MMRESULT WINAPI auxGetDevCapsA(UINT a,LPAUXCAPSA b,UINT c){}
MMRESULT WINAPI auxGetDevCapsW(UINT a,LPAUXCAPSW b,UINT c){}
MMRESULT WINAPI auxSetVolume(UINT a,DWORD b){}
MMRESULT WINAPI auxGetVolume(UINT a,PDWORD b){}
MMRESULT WINAPI auxOutMessage(UINT a,UINT b,DWORD c,DWORD d){}
UINT WINAPI mixerGetNumDevs(void){}
MMRESULT WINAPI mixerGetDevCapsA(UINT a,LPMIXERCAPSA b,UINT c){}
MMRESULT WINAPI mixerGetDevCapsW(UINT a,LPMIXERCAPSW b,UINT c){}
MMRESULT WINAPI mixerOpen(LPHMIXER a,UINT b,DWORD c,DWORD d,DWORD e){}
MMRESULT WINAPI mixerClose(HMIXER a){}
DWORD WINAPI mixerMessage(HMIXER a,UINT b,DWORD c,DWORD d){}
MMRESULT WINAPI mixerGetLineInfoA(HMIXEROBJ a,LPMIXERLINEA b,DWORD c){}
MMRESULT WINAPI mixerGetLineInfoW(HMIXEROBJ a,LPMIXERLINEW b,DWORD c){}
MMRESULT WINAPI mixerGetID(HMIXEROBJ a,PUINT b,DWORD c){}
MMRESULT WINAPI mixerGetLineControlsA(HMIXEROBJ a,LPMIXERLINECONTROLSA b,DWORD c){}
MMRESULT WINAPI mixerGetLineControlsW(HMIXEROBJ a,LPMIXERLINECONTROLSW b,DWORD c){}
MMRESULT WINAPI mixerGetControlDetailsA(HMIXEROBJ a,LPMIXERCONTROLDETAILS b,DWORD c){}
MMRESULT WINAPI mixerGetControlDetailsW(HMIXEROBJ a,LPMIXERCONTROLDETAILS b,DWORD c){}
MMRESULT WINAPI mixerSetControlDetails(HMIXEROBJ a,LPMIXERCONTROLDETAILS b,DWORD c){}
MMRESULT WINAPI timeGetSystemTime(LPMMTIME a,UINT b){}
DWORD WINAPI timeGetTime(void){}
MMRESULT WINAPI timeSetEvent(UINT a,UINT b,LPTIMECALLBACK c,DWORD d,UINT e){}
MMRESULT WINAPI timeKillEvent(UINT a){}
MMRESULT WINAPI timeGetDevCaps(LPTIMECAPS a,UINT b){}
MMRESULT WINAPI timeBeginPeriod(UINT a){}
MMRESULT WINAPI timeEndPeriod(UINT a){}
UINT WINAPI joyGetNumDevs(void){}
MMRESULT WINAPI joyGetDevCapsA(UINT a,LPJOYCAPSA b,UINT c){}
MMRESULT WINAPI joyGetDevCapsW(UINT a,LPJOYCAPSW b,UINT c){}
MMRESULT WINAPI joyGetPos(UINT a,LPJOYINFO b){}
MMRESULT WINAPI joyGetPosEx(UINT a,LPJOYINFOEX b){}
MMRESULT WINAPI joyGetThreshold(UINT a,LPUINT b){}
MMRESULT WINAPI joyReleaseCapture(UINT a){}
MMRESULT WINAPI joySetCapture(HWND a,UINT b,UINT c,BOOL d){}
MMRESULT WINAPI joySetThreshold(UINT a,UINT b){}
FOURCC WINAPI mmioStringToFOURCCA(LPCSTR a,UINT b){}
FOURCC WINAPI mmioStringToFOURCCW(LPCWSTR a,UINT b){}
LPMMIOPROC WINAPI mmioInstallIOProcA(FOURCC a,LPMMIOPROC b,DWORD c){}
LPMMIOPROC WINAPI mmioInstallIOProcW(FOURCC a,LPMMIOPROC b,DWORD c){}
HMMIO WINAPI mmioOpenA(LPSTR a,LPMMIOINFO b,DWORD c){}
HMMIO WINAPI mmioOpenW(LPWSTR a,LPMMIOINFO b,DWORD c){}
MMRESULT WINAPI mmioRenameA(LPCSTR a,LPCSTR b,LPCMMIOINFO c,DWORD d){}
MMRESULT WINAPI mmioRenameW(LPCWSTR a,LPCWSTR b,LPCMMIOINFO c,DWORD d){}
MMRESULT WINAPI mmioClose(HMMIO a,UINT b){}
LONG WINAPI mmioRead(HMMIO a,HPSTR b,LONG c){}
LONG WINAPI mmioWrite(HMMIO a,LPCSTR b,LONG c){}
LONG WINAPI mmioSeek(HMMIO a,LONG b,int c){}
MMRESULT WINAPI mmioGetInfo(HMMIO a,LPMMIOINFO b,UINT c){}
MMRESULT WINAPI mmioSetInfo(HMMIO a,LPCMMIOINFO b,UINT c){}
MMRESULT WINAPI mmioSetBuffer(HMMIO a,LPSTR b,LONG c,UINT d){}
MMRESULT WINAPI mmioFlush(HMMIO a,UINT b){}
MMRESULT WINAPI mmioAdvance(HMMIO a,LPMMIOINFO b,UINT c){}
LRESULT WINAPI mmioSendMessage(HMMIO a,UINT b,LPARAM c,LPARAM d){}
MMRESULT WINAPI mmioDescend(HMMIO a,LPMMCKINFO b,const MMCKINFO* c,UINT d){}
MMRESULT WINAPI mmioAscend(HMMIO a,LPMMCKINFO b,UINT c){}
MMRESULT WINAPI mmioCreateChunk(HMMIO a,LPMMCKINFO b,UINT c){}
MCIERROR WINAPI mciSendCommandA(MCIDEVICEID a,UINT b,DWORD c,DWORD d){}
MCIERROR WINAPI mciSendCommandW(MCIDEVICEID a,UINT b,DWORD c,DWORD d){}
MCIERROR WINAPI mciSendStringA(LPCSTR a,LPSTR b,UINT c,HWND d){}
MCIERROR WINAPI mciSendStringW(LPCWSTR a,LPWSTR b,UINT c,HWND d){}
MCIDEVICEID WINAPI mciGetDeviceIDA(LPCSTR a){}
MCIDEVICEID WINAPI mciGetDeviceIDW(LPCWSTR a){}
MCIDEVICEID WINAPI mciGetDeviceIDFromElementIDA(DWORD a,LPCSTR b){}
MCIDEVICEID WINAPI mciGetDeviceIDFromElementIDW(DWORD a,LPCWSTR b){}
BOOL WINAPI mciGetErrorStringA(MCIERROR a,LPSTR b,UINT c){}
BOOL WINAPI mciGetErrorStringW(MCIERROR a,LPWSTR b,UINT c){}
BOOL WINAPI mciSetYieldProc(MCIDEVICEID a,YIELDPROC b,DWORD c){}
HTASK WINAPI mciGetCreatorTask(MCIDEVICEID a){}
YIELDPROC WINAPI mciGetYieldProc(MCIDEVICEID a,PDWORD b){}
