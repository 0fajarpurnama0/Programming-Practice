...
WINSHELLAPI UINT APIENTRY DragQueryFileA(HDROP hDrop, UINT v1,LPSTR str,UINT v2) { }
WINSHELLAPI UINT APIENTRY DragQueryFileW(HDROP hDrop,UINT v1,LPWSTR str,UINT v2) { }
#ifdef UNICODE
#define DragQueryFile  DragQueryFileW
#else
#define DragQueryFile  DragQueryFileA
#endif // !UNICODE
WINSHELLAPI BOOL APIENTRY DragQueryPoint(HDROP hDrop,LPPOINT pt) { }
WINSHELLAPI VOID APIENTRY DragFinish(HDROP hDrop) { }
WINSHELLAPI VOID APIENTRY DragAcceptFiles(HWND hWnd,BOOL flag) { }
