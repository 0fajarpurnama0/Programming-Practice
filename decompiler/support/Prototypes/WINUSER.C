...
WINUSERAPI int WINAPIV wsprintfA(LPSTR dst, LPCSTR fmt, ...) {}
WINUSERAPI int WINAPIV wsprintfW(LPWSTR dst, LPCWSTR fmt, ...) {}
#ifdef UNICODE
...
WINUSERAPI BOOL    WINAPI DrawFrameControl(HDC hDC, LPRECT pRect, UINT v1, UINT v2) {}
...
WINUSERAPI BOOL    WINAPI DrawCaption(HWND hWnd, HDC hDC, CONST RECT *pRect, UINT val) {}
...
#if(WINVER >= 0x0400)
WINUSERAPI long  WINAPI  BroadcastSystemMessageA(DWORD v1, LPDWORD p1, UINT v3, WPARAM wParam, LPARAM lParam) {}
WINUSERAPI long  WINAPI  BroadcastSystemMessageW(DWORD v1, LPDWORD p1, UINT v3, WPARAM wParam, LPARAM lParam) {}
#ifdef UNICODE
...
ATOM
WINAPI
RegisterClassExA(CONST WNDCLASSEXA *pclass) { }
WINUSERAPI
ATOM
WINAPI
RegisterClassExW(CONST WNDCLASSEXW *pclass) { }
#ifdef UNICODE
...
BOOL
WINAPI
GetClassInfoExA(HINSTANCE hInst, LPCSTR name, LPWNDCLASSEXA pclass) { }
WINUSERAPI
BOOL
WINAPI
GetClassInfoExW(HINSTANCE hInst, LPCWSTR name, LPWNDCLASSEXW pclass) { }
#ifdef UNICODE
...
WINUSERAPI BOOL    WINAPI TrackPopupMenuEx(HMENU hMenu, UINT v1, int v2, int v3, HWND hWnd, LPTPMPARAMS pParam) {}
#endif /* WINVER >= 0x0400 */
...
DWORD
WINAPI
DragObject(HWND hWnd, HWND hObj, UINT val, DWORD dval, HCURSOR hCursor) { }
...
int
WINAPI
DrawTextExA(HDC hDC, LPSTR txt, int len, LPRECT rect, UINT val, LPDRAWTEXTPARAMS pTextParams) { }
WINUSERAPI
int
WINAPI
DrawTextExW(HDC hDC, LPWSTR txt, int len, LPRECT rect, UINT val, LPDRAWTEXTPARAMS pTextParams) { }
#ifdef UNICODE
...
WINUSERAPI BOOL WINAPI DrawStateA(HDC hDc, HBRUSH hBrush, DRAWSTATEPROC drawProc, LPARAM lParam, WPARAM wParam, int v1, int v2, int v3, int v4, UINT v5) {}
WINUSERAPI BOOL WINAPI DrawStateW(HDC hDc, HBRUSH hBrush, DRAWSTATEPROC drawProc, LPARAM lParam, WPARAM wParam, int v1, int v2, int v3, int v4, UINT v5) {}
#ifdef UNICODE
...
WINUSERAPI BOOL  WINAPI  SetMenuContextHelpId(HMENU hMenu, DWORD id) {}
...
WINUSERAPI int     WINAPI MessageBoxIndirectA(LPMSGBOXPARAMSA pMsgBox) {}
WINUSERAPI int     WINAPI MessageBoxIndirectW(LPMSGBOXPARAMSW pMsgBox) {}
#ifdef UNICODE
...
WINUSERAPI HWND    WINAPI ChildWindowFromPointEx(HWND hWnd, POINT pt, UINT v) {}
#endif /* WINVER >= 0x0400 */
...
#if(WINVER >= 0x0400)
WINUSERAPI HWND    WINAPI FindWindowExA(HWND hWnd, HWND hWnd1, LPCSTR str, LPCSTR str1) {}
WINUSERAPI HWND    WINAPI FindWindowExW(HWND hWnd, HWND hWnd1, LPCWSTR str, LPCWSTR str1) {}
#ifdef UNICODE
...
WINUSERAPI int     WINAPI SetScrollInfo(HWND hWnd, int v, LPCSCROLLINFO pScroll, BOOL flag) {}
WINUSERAPI BOOL    WINAPI GetScrollInfo(HWND hWnd, int v, LPSCROLLINFO pScroll) {}
#endif /* WINVER >= 0x0400 */
#endif /* !NOWINMESSAGES */
#endif /* !NOCTLMGR */
